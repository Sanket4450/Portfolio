  ...
  ({ projectName, id, image, title, titleDesc, projectURL, githubURL, descPoints, technologies, align }, ref) => {
    return (
      ...
      >
        ...
        <div className=" w-full lg:w-[54%] xl:w-[48%] space-y-7 max-lg:pt-10 max-lg:pb-6 lg:py-3">
          ...
          <div>
            ...
            <div className=" flex flex-wrap items-center mt-3 gap-y-5">
              {technologies.map((technology) => (
                <a
                  key={technology.id}
                  href={technology.link}
                  className=" w-14 flex justify-center items-center mx-1 rounded-sm"
                >

...
export const WorkCard = ({ image, title, path, extraClasses }) => {
  return (
    <div
      className={` w-[92%] phone:w-[75%] sm:w-[450px] lg:w-[32.5%] h-56 phone:h-72 sm:h-[370px] lg:h-80 xl:h-96 ${extraClasses}`}
    >
      <img src={image} className=" w-full h-[75%] hover:cursor-pointer" />
      <div className=" h-[25%] flex flex-col justify-center space-y-1">

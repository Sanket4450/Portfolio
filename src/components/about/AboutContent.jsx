...
export const AboutContent = () => {
  return (
    <section className=" md:flex md:justify-between md:space-x-5 max-md:space-y-8 py-10">
      <div className=" md:w-[60%] md:py-5 space-y-8">
        ...
        <div className=" space-y-2">
          ...
          <p className=" text-primary text-sm">{userDetails.expertise}</p>
        </div>
        <div className=" space-y-2">
          <h2 className=" text-primary text-2xl sm:text-xl lg:text-3xl font-semibold">Vision:</h2>
          <p className=" text-primary text-sm">{userDetails.vision}</p>
        </div>
        <div className=" md:max-lg:hidden flex justify-center p-5">
      ...
      <div className=" phone:w-[70%] md:w-[280px] lg:w-96 mx-auto space-y-8">
        ...
        <div className=" max-md:hidden lg:hidden flex justify-center p-5">
          <img src={aboutDetails.techStackLogo} className=" w-[80%] lg:w-80" />
        </div>
      </div>
    </section>
  )
